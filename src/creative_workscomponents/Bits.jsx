...
const bits = [
  ...
  },
  {
    ...
    link:
      "https://drive.google.com/drive/folders/1RwFtuDcEaj48a8RaubtwUXmLlBD-simE",
  },
];
    ...
    <section className="bg-[#FCF8F3] py-24">
      <div className="mx-auto max-w-[1280px]">
        ...
        <div className="grid grid-cols-3 justify-items-center gap-x-8 gap-y-10">
          {bits.map((item, index) => {
            const isSafePay = item.image === "safepay.png";
                ...
                <div className="relative h-[300px] overflow-hidden rounded-xl">
                  ...
                  <img
                    ...
                    className={`
                      ...
                      duration-700
                      ${isSafePay ? "scale-[1.35]" : "scale-100"}
                  ...
                  <div
                    ...
                    style={{
                      background: `radial-gradient(
                        circle 160px at ${
                          mousePos[index]?.x || 170
                        }px ${mousePos[index]?.y || 150}px,
