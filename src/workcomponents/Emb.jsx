        ...
        <div className="grid grid-cols-12 gap-12 items-center">
          ...
          <div className="col-span-7">
            <div className="bg-[#ECE7E1] rounded-[42px] p-6">
              ...
              <div className="w-full h-[330px] rounded-[28px] bg-[#D9D4CD] overflow-hidden">
                {/* Put image here */}
                <img src="emb.png" alt="" className="w-full h-full object-cover" />
              </div>
              ...
              <div className="mt-8">
                ...
                <p className="mt-5 max-w-[520px] text-[16px] leading-[30px] text-[#5B5350] font-jakarta">
                  Proto typed a relationship focused app that helps couples explore compatibility and build meaningful connections.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-5 flex flex-col items-start">
            ...
            <div className="w-full bg-[#EAE8E3] rounded-[42px] p-10 relative rotate-1">
              ...
              {/* Quote */}
              <p className="mt-14 text-[15px] italic leading-[28px] text-[#6C6662] font-newsreader text-nowrap">
                “ Designing experiences built around trust and connection”
              </p>
            </div>
            ...
            <button className="group flex items-center gap-4 mt-8">
              <a
                href="https://www.behance.net/gallery/213221637/Embrace"
                target="_blank"
